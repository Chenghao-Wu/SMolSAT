...
class msd2d:
    def __init__(self,system=None,trajs=None,listname=None,out=None,plane=None):
        self.system=system
        self.trajs=trajs
        ...
        self.analysis=Mean_Square_Displacement_2D(system,plane)
    ...
    def plot(self,file=None):
        ...
        ax.plot(self.data["t"],self.data["msd"],**next(linestyle),label=None,zorder=3)
