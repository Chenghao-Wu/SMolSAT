...
class vhd:
    def __init__(self,system=None,trajs=None,listname1=None,listname2=None,out=None,nbins=None,r_cut=None):
        self.system=system
        self.trajs=trajs
        ...
        self.analysis=Van_Hove_Distinct(system,nbins,r_cut)
